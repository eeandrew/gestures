...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ImgTest = __webpack_require__(160);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Gestures = __webpack_require__(161);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Gestures = function (_Component) {
	  _inherits(Gestures, _Component);

	  function Gestures(props) {
	    _classCallCheck(this, Gestures);

	    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(Gestures).call(this, props));
	  ...
	  _createClass(Gestures, [{
	    ...
	    value: function _getRotateDirection(vector1, vector2) {
	      return vector1.x * vector2.y - vector2.x * vector1.y;
	    }
	  }, {
	    key: '_getRotateAngle',
	    value: function _getRotateAngle(vector1, vector2) {
	      var direction = this._getRotateDirection(vector1, vector2);
	      direction = direction > 0 ? -1 : 1;
	      var len1 = this._getDistance(vector1);
	      var len2 = this._getDistance(vector2);
	      var mr = len1 * len2;
	      if (mr === 0) return 0;
